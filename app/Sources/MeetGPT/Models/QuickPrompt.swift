...
enum QuickPrompts {
    ...
    static let all: [QuickPrompt] = [
        .init(id: "agenda",
              ...
              tooltip: "Draft a time-boxed agenda with owners and parking lot",
        ...
        .init(id: "brainstorm",
              ...
              tooltip: "Group new ideas with rationale and next steps",
        ...
        .init(id: "unresolved",
              ...
              tooltip: "List open or parked topics with owners and dates",
        ...
        .init(id: "whattoask",
              icon: "🎯",
              title: "What To Ask",
              tooltip: "Surface missing, shallow, or vague topics with ready-to-ask questions",
        ...
        .init(id: "factcheck",
              icon: "🔎",
              title: "Fact Check",
              tooltip: "Verify recent factual claims and mark their status",
        ...
        .init(id: "rhetoric",
              ...
              tooltip: "Flag fallacies, pressure tactics, and loaded framing",
        ...
        .init(id: "answer",
              icon: "🙋",
              title: "Answer Last Question",
              tooltip: "Respond to the latest question aimed at you",
        ...
        .init(id: "dispute",
              ...
              tooltip: "Summarize disagreement and offer decision options",
        ...
        .init(id: "risks",
              ...
              tooltip: "Compile a risk register with likelihood and impact",
        ...
        .init(id: "advice",
              icon: "🧭",
              title: "Give Advice",
              tooltip: "Offer actionable recommendations and role tips",
        ...
        .init(id: "tasks",
              ...
              tooltip: "Assign roles and compile action items",
        ...
        .init(id: "logdecision",
              icon: "📌",
              title: "Log Decision",
              tooltip: "Capture the decision just made into your Decision Ledger",
        ...
        .init(id: "summary",
              ...
              tooltip: "Provide a structured summary of the meeting",
        ...
        .init(id: "steelman",
              icon: "⚔️",
              title: "Argue Against",
              tooltip: "Argue the strongest case against what the room just agreed",
        ...
        .init(id: "commitments",
              ...
              tooltip: "Surface prior promises still outstanding and whether this call addresses them",
        ...
        .init(id: "recall",
              ...
              tooltip: "Answer from past meetings, quoting the call it came from",
