...
version: 1.58.1
# Publishes to a live X/Twitter account and drives Chrome CDP automation to do
# it. Triggers on "post", "tweet", "share" — words a meeting says constantly —
# so it is barred from automatic selection. Resolvable by id.
risk: critical
metadata:
  openclaw:
