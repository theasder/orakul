...
системных запросов, свой словарь. 3104 тестов проходят.
...
ViewInspector для тестов представлений. Пять минут — это про `mvp/`.
...
Тесты: `cd app && swift test` (2654 штук), mvp — 294 и `npm test` в корне (156 — про
