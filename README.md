...
системных запросов, свой словарь. 3312 тестов проходят.
...
Страница проекта: <https://cruxwing.ai/ru>. Домен orakul.ai
...
Тесты: `cd app && swift test` (2708 штук), mvp — 407 и `npm test` в корне (197 — про
