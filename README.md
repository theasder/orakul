...
системных запросов, свой словарь. 3074 тестов проходят.
...
Тесты: `cd app && swift test` (2656 штук), mvp — 277 и `npm test` в корне (141 — про
...
Сборка установщика: `cd app && MEETGPT_ARCH=arm64 ./notarize.sh && ./dmg.sh`.
