...
созвонам. Отдельная идентичность (`ai.orakul.desktop`), русские тексты
системных запросов, свой словарь. 2505 тестов проходят.
...
Тесты: `cd app && swift test` (2505 штук) и `npm test` в корне (37 — про
