...
системных запросов, свой словарь. 3230 тестов проходят.
...
Тесты: `cd app && swift test` (2679 штук), mvp — 358 и `npm test` в корне (193 — про
...
нотаризованы Apple; лежат в [выпуске](https://github.com/theasder/orakul/releases/latest).
